...
<body>
    ...
    <div class="container mt-5" id="data">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary">
            ...
            <div class="navbar-collapse d-flex justify-content-center" id="navbarNavAltMarkup">
                ...
                <a class="navbar-brand " href="#">
                    ...
                    <img src="img/finaltransparentlogonavbar.png" class="me-2" height="140" alt="Coop Logo" loading="lazy" />
                </a>
        ...
        <div class="container mt-5" style="height: 80vh;">
            ...
            <!-- Section 5: Featured Highlights / Gallery / Members / Any Use -->
        ...
        <div class="container">
            <div class="row text-start py-4">
                ...
                <div class="col-md-3 d-flex align-items-center justify-content-center">
                    <img src="img/finaltransparentlogo.png" alt="Coop Logo" class="img-fluid" style="max-height: 300px;">
                </div>
